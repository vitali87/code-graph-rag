...
MCP_GLOSSES = (
    ...
    "EXACT while the definition's code is unchanged since the note was "
    "written and STALE once it has changed (graded after each sync; a "
    "class or module subject is not graded). " + _MCP_DETERMINISTIC_NOTE
)
