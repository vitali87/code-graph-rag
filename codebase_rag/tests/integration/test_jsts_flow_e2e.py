...
def test_env_flows_to_stdout(graph_ingestor: GraphIngestor, tmp_path: Path) -> None:
    _build(
        graph_ingestor,
        tmp_path,
        "app.js",
...
def test_untainted_value_no_flow(graph_ingestor: GraphIngestor, tmp_path: Path) -> None:
    _build(
        graph_ingestor,
        tmp_path,
        "app.js",
