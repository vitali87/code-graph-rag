...
def test_go_direct_io_sinks(graph_ingestor: GraphIngestor, tmp_path: Path) -> None:
    _build(graph_ingestor, tmp_path, _GO_CODE)
...
def test_go_aliased_import_emits(graph_ingestor: GraphIngestor, tmp_path: Path) -> None:
