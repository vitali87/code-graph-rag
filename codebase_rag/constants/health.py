...
HEALTH_CHECK_GRAPH_SUCCESSFUL = "{backend} connection successful"
HEALTH_CHECK_GRAPH_FAILED = "{backend} connection failed"
HEALTH_CHECK_GRAPH_CONNECTED_MSG = "Connected and responsive at {host}:{port}"
HEALTH_CHECK_GRAPH_CONNECTION_FAILED_MSG = "Connection or query failed"
HEALTH_CHECK_GRAPH_ERROR = "{backend} error: {error}"
HEALTH_CHECK_GRAPH_QUERY = "RETURN 1 AS test;"
