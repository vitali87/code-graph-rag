...
from .ast_julia import (
    TS_JULIA_ABSTRACT_DEFINITION,
    TS_JULIA_ARROW_FUNCTION_EXPRESSION,
    TS_JULIA_ASSIGNMENT,
    TS_JULIA_BROADCAST_CALL_EXPRESSION,
    TS_JULIA_CALL_EXPRESSION,
    TS_JULIA_FUNCTION_DEFINITION,
    TS_JULIA_IMPORT_STATEMENT,
    TS_JULIA_MACRO_DEFINITION,
    TS_JULIA_MACROCALL_EXPRESSION,
    TS_JULIA_MODULE_DEFINITION,
    TS_JULIA_PRIMITIVE_DEFINITION,
    TS_JULIA_SOURCE_FILE,
    TS_JULIA_STRUCT_DEFINITION,
    TS_JULIA_USING_STATEMENT,
)
from .ast_lua import (
    TS_LUA_CHUNK,
...
# Scopes: the file root, a nested `module X` block, and a struct body (an
# inner constructor's qn is `mod.Point.Point`, the C#/Java ctor convention).
FQN_JULIA_SCOPE_TYPES = (
    TS_JULIA_SOURCE_FILE,
    TS_JULIA_MODULE_DEFINITION,
    TS_JULIA_STRUCT_DEFINITION,
)
FQN_JULIA_FUNCTION_TYPES = (
    TS_JULIA_FUNCTION_DEFINITION,
    TS_JULIA_MACRO_DEFINITION,
    TS_JULIA_ARROW_FUNCTION_EXPRESSION,
    TS_JULIA_ASSIGNMENT,
...
SPEC_JULIA_FUNCTION_TYPES = FQN_JULIA_FUNCTION_TYPES
SPEC_JULIA_CLASS_TYPES = (
    TS_JULIA_STRUCT_DEFINITION,
    TS_JULIA_ABSTRACT_DEFINITION,
    TS_JULIA_PRIMITIVE_DEFINITION,
)
SPEC_JULIA_MODULE_TYPES = (TS_JULIA_SOURCE_FILE, TS_JULIA_MODULE_DEFINITION)
SPEC_JULIA_CALL_TYPES = (
    TS_JULIA_CALL_EXPRESSION,
    TS_JULIA_MACROCALL_EXPRESSION,
    TS_JULIA_BROADCAST_CALL_EXPRESSION,
)
SPEC_JULIA_IMPORT_TYPES = (TS_JULIA_USING_STATEMENT, TS_JULIA_IMPORT_STATEMENT)
